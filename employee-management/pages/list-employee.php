        ...
        foreach($employees as $employee){
          ?>
              <tr>
                ...
                <td>
                  <?php echo ucfirst($employee['designation']) ?>
                </td>
                <td>
                  <a href="admin.php?page=employee-system&action=edit&empId=<?php echo $employee['id'] ?>"
                    class="btn btn-warning">Edit</a>

                  <form id="frm-delete-employee-<?php 
          echo $employee['id'] ?>" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>?page=list-employee">
          ...
          jQuery('#frm-delete-employee-<?php echo $employee['id'] ?>').submit();}" class="btn btn-danger">Delete</a>
